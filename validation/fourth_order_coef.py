...
from linearwavetheory.stokes_theory.regular_waves.eularian_velocity_amplitudes import dimensionless_velocity_amplitude
...
def x4n(dimensionless_depth, dimensionless_height,n):
    ...
    sh4 = terms.sh(4,dimensionless_depth,dimensionless_height)
