...
def ch(n,dimensionless_depth, dimensionless_height):
    return np.cosh( n * (dimensionless_depth+dimensionless_height) )/np.cosh( n * dimensionless_depth )

def sh(n,dimensionless_depth, dimensionless_height):
    return np.sinh( n * (dimensionless_depth+dimensionless_height) )/np.cosh( n * dimensionless_depth )
...
def u11(dimensionless_depth, dimensionless_height):
    return ch(1,dimensionless_depth,dimensionless_height) * dimensionless_velocity_amplitude(1,dimensionless_depth,1,order=1)

def w11(dimensionless_depth, dimensionless_height):
    return sh(1,dimensionless_depth,dimensionless_height) * dimensionless_velocity_amplitude(1,dimensionless_depth,1,order=1)

def u22(dimensionless_depth, dimensionless_height):
    return ch(2,dimensionless_depth,dimensionless_height) * dimensionless_velocity_amplitude(1,dimensionless_depth,2,order=2)

def w22(dimensionless_depth, dimensionless_height):
    return sh(2,dimensionless_depth,dimensionless_height) * dimensionless_velocity_amplitude(1,dimensionless_depth,2,order=2)

def u33(dimensionless_depth, dimensionless_height):
    return ch(3,dimensionless_depth,dimensionless_height) * dimensionless_velocity_amplitude(1,dimensionless_depth,3,order=3)

def w33(dimensionless_depth, dimensionless_height):
    return sh(3,dimensionless_depth,dimensionless_height) * dimensionless_velocity_amplitude(1,dimensionless_depth,3,order=3)
...
def validate(target,new,name, plot=False):
    ...
    for z in height:
        ...
        if diff > 1e-8:
            ...
            raise AssertionError(f"Validation failed for {name} at height {z}: max diff = {diff:.2e}")
